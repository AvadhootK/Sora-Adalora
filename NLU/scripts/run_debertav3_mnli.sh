python -u ../examples/text-classification/run_glue.py \
...
--do_train --do_eval \
--max_seq_length 2048 \
--per_device_train_batch_size 16 --learning_rate 1e-4 --num_train_epochs 10 \
--warmup_steps 1000 \
--cls_dropout 0.15 --weight_decay 0 \
...
--logging_steps 500 \
--seed 6 \
--root_output_dir ./output/glue/llama/rte \
--overwrite_output_dir