...
# data_path = 'D:/LLM/rte-20240705T225031Z-001/'
data_path = '/scratch/ak10576/sora_v2/Glue-Datasets/rte-20240705T225031Z-001/'
...
def main():
    ...
    if data_args.task_name is not None:
        ...
        raw_datasets = load_dataset("glue",data_args.task_name,trust_remote_code=True)
        # raw_datasets = load_dataset("super_glue",data_args.task_name,trust_remote_code=True)
    ...
    if data_args.task_name is not None:
        metric = load_metric("./glue.py", data_args.task_name, trust_remote_code=True)
        # superglue
        # metric = load_metric("super_glue", data_args.task_name, trust_remote_code=True)
    else:
    ...
    train_dataset_for_eval = train_dataset.shuffle(seed=42).select(range(1))
