...
main_dir = '/scratch/ak10576/sora_v2/Glue-Datasets/rte-20240705T225031Z-001'
...
class AbstractTask(abc.ABC):
    ...
    def load_dataset(self, split):
        ...
        tmp = load_dataset("nyu-mll/glue",self.name,trust_remote_code=True)
        # superglue
        # a = self.name.split('-')[1]
        # tmp = datasets.load_dataset("super_glue",a,trust_remote_code=True)
        return tmp[split]
